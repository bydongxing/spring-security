...
//    }
    ...
    private Claims getClaimsFromToken(String token) {
        ...
        try {
            claims = Jwts.parser()
                    .setSigningKey(this.jwtConfig.getSecurity())
    ...
    private Date generateExpirationDate() {
        return new Date(System.currentTimeMillis() + this.jwtConfig.getExpireTime() * 1000);
    }
    ...
    String generateToken(Map<String, Object> claims) {
        return Jwts.builder()
                ...
                .signWith(SignatureAlgorithm.HS512, this.jwtConfig.getSecurity())
                .compact();
    }
